...
const perks = [
  ...
  { title: 'Smart routing', desc: 'AI-optimised routes mean more deliveries per hour and more money.', color: '#00D9F5' },
  { title: 'Full insurance cover', desc: 'Comprehensive insurance coverage on every single trip you complete.', color: '#00FFB3' },
...
export default function DriverExperience() {
  return (
    <section className="py-20 md:py-32 overflow-hidden" id="for-drivers"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <p className="text-xs font-semibold tracking-widest uppercase mb-5" style={{ color: '#00FFB3' }}>
            For drivers
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden" style={{ height: 480 }}>
              ...
              <div className="absolute inset-0"
                style={{ background: 'linear-gradient(180deg, transparent 40%, rgba(10,11,15,0.97) 100%)' }} />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    { label: 'Avg weekly earn', value: 'KSh 28k', color: '#00FFB3' },
              ...
              {/* Hiring badge */}
              <div className="absolute top-5 left-5 flex items-center gap-2 rounded-xl px-3 py-2"
          ...
          <div>
            ...
            {/* Perks — simple list with left border accent */}
