...
export default function Hero() {
  return (
    <section className="relative flex flex-col" style={{ background: '#FFFFFF', minHeight: '100svh' }}>
      ...
      {/* Two-column layout: left text, right image — fills full viewport height */}
      <div className="flex-1 grid lg:grid-cols-2" style={{ minHeight: 'inherit' }}>

        {/* Left: text content */}
        <div className="flex flex-col justify-center px-6 sm:px-10 xl:px-20 pt-28 pb-16 lg:pt-0 lg:pb-0">
          ...
          {/* Mobile stats — only below lg */}
          <div className="lg:hidden grid grid-cols-2 gap-px mt-12 pt-10" style={{ borderTop: '1px solid #E5E8ED' }}>
            {[
              ...
              <div
                key={i}
                className="py-5 px-2 flex flex-col gap-1"
        ...
        <div className="hidden lg:flex flex-col relative overflow-hidden">
          ...
          <div
            className="absolute bottom-10 left-6 right-6 rounded-2xl px-5 py-4 flex items-center gap-4"
            style={{ background: 'rgba(255,255,255,0.94)', backdropFilter: 'blur(16px)', boxShadow: '0 8px 32px rgba(0,0,0,0.10)', border: '1px solid #E5E8ED' }}
          >
            <div
      ...
      {/* Stats bar — desktop, full width at bottom of hero */}
      <div className="hidden lg:block border-t" style={{ borderColor: '#E5E8ED' }}>
