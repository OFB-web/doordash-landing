...
export default function Hero() {
  return (
    /*
     * Section is a CSS grid: 2 cols (lg) × 2 rows [1fr auto].
     * Row 1 = content + image (1fr → fills viewport minus stats bar).
     * Row 2 = stats bar (auto height).
     * This gives the image cell an explicit height so next/image fill works.
     */
    <section
    ...
    >
      ...
      <div className="flex flex-col justify-center px-6 sm:px-10 xl:px-20 pt-28 pb-16 lg:pt-0 lg:pb-0">
        ...
        {/* Mobile stats — shown only on mobile, inlined in left content */}
      ...
      {/* ── Right: full-height image — desktop only (row 1, col 2) ── */}
      ...
      {/* ── Stats bar — desktop only (row 2, spans both cols) ── */}
      <div
        className="hidden lg:grid grid-cols-4 lg:col-span-2 border-t"
